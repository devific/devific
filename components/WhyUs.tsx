        ...
        <div className="grid grid-cols-12 gap-12 lg:gap-24">
          <div className="col-span-12 lg:col-span-5">
            <div className="sticky top-32">
              ...
              <h3 className="text-5xl font-serif text-zinc-900 leading-[1.1] mb-8">
                Devific is the partner for the intentional.
              </h3>
          ...
          <div className="col-span-12 lg:col-span-7">
            <div className="grid grid-cols-1 gap-12">
              {points.map((point, idx) => (
                <div key={idx} className="flex group max-lg:flex-col">
                  ...
                  <div>
                    <h4 className="text-2xl font-serif text-zinc-900 mb-3">
                      {point.title}
                    </h4>
