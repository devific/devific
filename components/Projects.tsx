...
const Projects: React.FC = () => {
  const highlight: Project = {
    ...
    url: "#",
    description: "High-performance e-commerce platform for a luxury skincare brand."
  };
  ...
  const others: Project[] = [
    {
      ...
      url: "#",
      description: "A venture capital platform designed for high-speed analysis."
    },
    {
      name: "Vellum Stationery",
      image: "https://images.unsplash.com/photo-1586075010620-2255bc972183?q=80&w=1000&auto=format&fit=crop",
      url: "#",
      description: "Minimalist boutique store with a focus on tactile typography."
    },
    {
      name: "Stellar Dashboard",
      image: "https://images.unsplash.com/photo-1551288049-bbbda540257a?q=80&w=1000&auto=format&fit=crop",
      url: "#",
    ...
    <section id="work" className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <motion.div 
          ...
          className="mb-24"
        >
          <h2 className="text-sm font-semibold text-indigo-600 uppercase tracking-widest mb-4">Selected Work</h2>
          <h3 className="text-5xl font-serif text-zinc-900 leading-tight">Projects built with <br/>focus and intention.</h3>
        </motion.div>
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 p-8 md:p-16 text-white translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
            <h4 className="text-4xl md:text-6xl font-serif mb-4">{highlight.name}</h4>
            <p className="text-lg md:text-xl text-zinc-200 font-light mb-8 max-w-lg">{highlight.description}</p>
            <a 
              href={highlight.url}
            ...
            >
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <h4 className="text-2xl font-serif text-zinc-900">{project.name}</h4>
