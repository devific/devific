    ...
    <footer className="bg-white py-20 border-t border-zinc-100">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 space-y-6 hidden">
            <h4 className="text-sm font-semibold text-zinc-900 uppercase tracking-widest">
              Connect
            </h4>
            <ul className="space-y-4">
              <li>
                <a
                  href="mailto:hello@devific.com"
              ...
              <li>
                <span className="text-zinc-400 text-sm">
                  Based in Goa, India — Working Globally
                </span>
              </li>
            </ul>
          </div>
