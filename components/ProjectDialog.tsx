      ...
      >
        ...
        <div className="p-8 md:p-12">
          {!isSubmitted ? (
            <>
              <div className="mb-8">
                <h2 className="text-3xl font-serif text-zinc-900 mb-2">Tell us about your project</h2>
                <p className="text-zinc-500 font-light">Let's see if Devific is the right partner for you.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-zinc-700 ml-1">Project Type</label>
                          ...
                          {projectOptions.map((option) => (
                            <button
                              ...
                              className={`w-full text-left px-4 py-3 hover:bg-zinc-50 transition-colors text-sm ${
                                projectType === option ? 'text-indigo-600 bg-indigo-50/50' : 'text-zinc-600'
                              }`}
                            >
                              {option}
                            </button>
                ...
                <button 
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 bg-zinc-900 text-white rounded-xl font-medium hover:bg-indigo-600 transition-all flex items-center justify-center space-x-2 disabled:opacity-50"
                >
                  {loading ? (
            ...
            <div className="py-12 text-center space-y-6">
              ...
              <h2 className="text-3xl font-serif text-zinc-900">Message Received</h2>
